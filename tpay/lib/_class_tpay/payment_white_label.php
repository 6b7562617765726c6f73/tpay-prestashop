...
require_once dirname(__FILE__).'/payment_szkwal.php';

/**
 * Class PaymentWhiteLabel.
 */
class payment_white_label extends PaymentSzkwal
{
    /**
    ...
    {
        parent::__construct($apiLogin, $apiPassword, $apiHash, $partnerUniqueAddress, $titleFormat);
    }
