 ...
 * Instead  of  traditional  payment  gateway,  client  makes  a  payment  with  fixed  title  directly  from  his  online
...
class PaymentSzkwal
{
     ...
     * @var string
     */
    protected $apiPassword = '[SZKWAL_API_PASSWORD]';
    ...
    {
        Util::log('szkwal notification', print_r($_POST, true));
